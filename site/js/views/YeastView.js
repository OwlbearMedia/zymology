define([
  'underscore',
  'backbone',
  'text!templates/Yeast.html'
], function(_, Backbone, yeastTemplate) {
  var YeastView = Backbone.View.extend({
    tagName: 'div',

    className: 'yeast row-fluid',

    template: _.template(yeastTemplate),
